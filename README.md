...
번역문 검사 11층(`trcheck.py`)과 삽입 후 역검증 9단(`verify_insert.py`)입니다.
...
칸이 모자랍니다(747 < 803). `--no-engine`으로 3MB 빌드도 되지만, 그때는 `F4`가
