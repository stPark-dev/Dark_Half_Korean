...
`v0.9.1` 입니다. 대사·UI·메뉴·오프닝·컷신·아이템/장비/마법 이름은 끝났고,
...
| 목록 창 (아이템·장비·마법) | **98엔트리 + 메뉴 라벨 전부 단일바이트** — 반각 8×8 폰트 110자 |
...
**8×8 한글의 받침 ㅇ** — 두 픽셀 높이라 속공간을 낼 수 없어 「방어」가 「밤어」,
「강화」가 「감화」로 보입니다. 글꼴·문턱 후보 8개를 실제 이름으로 나란히 그려
NanumGothic 9px/60 을 골랐지만 이 한계는 남습니다. 제대로 고치려면 8×8 자모를
손으로 그려 조합해야 합니다.
