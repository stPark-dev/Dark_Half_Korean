...
`v0.9.2` 입니다. 대사·UI·메뉴·오프닝·컷신·아이템/장비/마법 이름은 끝났고,
...
| 검사 | 텍스트 **12층** + 삽입 역검증 **18단** + `test_kr` 10군 전부 통과 |
...
## 최근 작업 — 8×8 한글은 자모를 손으로 그려야 했습니다
...
번역문 검사 12층(`trcheck.py`)과 삽입 후 역검증 18단(`verify_insert.py`)입니다.
