...
| 원본 | 2026-09-08 캡처 |
|---|---|
| ![목록 창 원본](image/JP.png) | ![목록 창 깨짐](image/KR.png) |

아이템 창 VRAM 덤프로 경로를 확정했습니다. **이 창은 메뉴 폰트가 아니라 대사
폰트를 씁니다** — 이름과 설명에 필요한 글리프만 64바이트 통째로 VRAM `0x3000`
부터 올리고, **뱅크 이스케이프를 정상 해석합니다**(`F6 3f`가 F6의 0x3f 글리프로
올라간 것을 확인). 마법 이름표는 이미 번역돼 있습니다(`힐` = `f7 25`).
